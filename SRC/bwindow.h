...
// *****  as above but with the window name 
    bwindow(int w,int h, const char * name);
...
// ***** draw_point(): put a pixel at x1,y1 with color color
    ...
    void pixel_N_x(int,int,int,int);
    void pixel_N_y(int,int,int,int);
    void dessiner_poisson(double,double,double,double,int);
    void dessiner_algue(double position_x,double position_y,int couleur1, int couleur2);
